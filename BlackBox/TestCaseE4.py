...
z_train = gpn.max2(gpn.min2(gpn.cos1(x_train), gpn.sin1(y_train)), gpn.tan1(x_train/y_train))
...
z_test = gpn.max2(gpn.min2(gpn.cos1(x_test), gpn.sin1(y_test)), gpn.tan1(x_test/y_test))
